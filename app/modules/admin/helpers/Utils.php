...
final class Utils
{
     ...
     * @return string
     */
    public static function translit($string, $lang = 'ru', $params = [])
    {
        static $search = [];
        ...
        for ($i = 0; $i < $len; $i++) {
            ...
            if (preg_match("/[a-zA-Z0-9]/" . UTF_MODIFIER, $chr) || strpos($params["safe_chars"], $chr) !== false) {
                $chr_new = $chr;
            } elseif (preg_match("/\\s/" . UTF_MODIFIER, $chr)) {
                if (
